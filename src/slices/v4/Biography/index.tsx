            ...
            <div className="terminal-card h-full">
              ...
              <div className="p-6 space-y-6">
                ...
                <motion.div
                  ...
                  whileInView="visible"
                  viewport={{ once: true }}
                  className="font-mono text-xs space-y-1.5 p-4 rounded bg-muted/30 border border-border/50"
                >
                  <div className="text-muted-foreground">
                    <span className="text-accent">$</span> cat interests.txt
                  </div>
                  <div className="text-foreground pl-2 space-y-0.5">
                    <motion.div variants={listItemVariants}><span className="text-accent">&#x25B8;</span> Machine Learning &amp; Deep Learning</motion.div>
                    <motion.div variants={listItemVariants}><span className="text-accent">&#x25B8;</span> Data Analysis &amp; Visualization</motion.div>
                    <motion.div variants={listItemVariants}><span className="text-accent">&#x25B8;</span> Full-Stack Development</motion.div>
                    <motion.div variants={listItemVariants}><span className="text-accent">&#x25B8;</span> Algorithm Design</motion.div>
                  </div>
                </motion.div>
